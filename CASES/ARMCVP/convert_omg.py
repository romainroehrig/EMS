...
f = open('data_create_profiles/data_received_from_francoise/KIT_IDEAL/DATA/layer_idea_2days_advver.dat')
...
g = cdms2.open('ARMCVP_FG_omg.nc','w')
...
g.comment = 'Initial conditions and forcing for ARM CVP case'
