...
f = cdms2.open('AYOTTE_A03SC_driver_FC.nc')
...
#lev = [0,5,130,400,415,444,464,474,475,484,500,504,544,564,600,634,664,694,724,756,786,864,895,1000,1500,1750,2000,3000,4000]
lev =range(0,5000,10)
nlev = len(lev)
