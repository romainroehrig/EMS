...
f = cdms2.open('AYOTTE_A05WC_driver_FC.nc')
...
#lev = [0,5,100,200,812,831,850,869,888,900,907,926,945,964,984,1000,1003,1022,1041,1060,1079,1098,1117,1136,1150,1155,1174,1194,1213,1232,1251,1270,1289,1308,1327,1346,1366,1384,1404,1423,1442,1461,1480,1499,1518,1537,1556,1576,1595,1614,1633,1652,1671,1690,1709,1750,2000,3000,4000]
lev = range(0,5000,10)
nlev = len(lev)
