...
f = cdms2.open('AYOTTE_A24F_driver_FC.nc')
...
nlev = 11 + 7
lev = [0,5,130,829,848,900,908,928,968,1000,1008,1048,1100,1388,1750,1787,2000,3000]
...
datanew['ustar'][:,0,0] = datanew['ustar'][:,0,0] + 0

g = cdms2.open('AYOTTE_A24F_driver_FC_RR.nc','w')
