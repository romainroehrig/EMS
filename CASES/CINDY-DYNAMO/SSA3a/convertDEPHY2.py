...
f = cdms2.open('cindy_ssa3a_extended.nc')
...
varnames = {}
for var in ['temp','qv','u','v','tadvh','qadvh','omega','ps','pressure','ts']:
  varnames[var] = var
...
g = cdms2.open('cindy-dynamo-SSA3a_driver_RR.nc','w')
...
g.comment = 'Forcing and initial conditions for CINDY-DYNAMO SSA3a case'
g.reference = 'http://johnson.atmos.colostate.edu/dynamo/products/array_averages/index.html'
g.author = 'R. Roehrig'


g.case = 'CINDY-DYNAMO - SSA3a'
