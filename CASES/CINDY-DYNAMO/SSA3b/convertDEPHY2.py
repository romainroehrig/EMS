...
f = cdms2.open('cindy_ssa3b_extended.nc')
...
g = cdms2.open('cindy-dynamo-SSA3b_driver_RR.nc','w')
...
g.comment = 'Forcing and initial conditions for CINDY-DYNAMO SSA3b case'
g.reference = 'http://johnson.atmos.colostate.edu/dynamo/products/array_averages/index.html'
g.author = 'R. Roehrig'


g.case = 'CINDY-DYNAMO - SSA3b'
