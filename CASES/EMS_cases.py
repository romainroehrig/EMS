...
for SST in [28,]:
  ...
  subcases[case] = subcases[case] + ['KUANG_SST{0}_TM02_l{1:0>2}_DEPHY'.format(SST,lev) for lev in range(90,39,-1)]
  subcases[case] = subcases[case] + ['KUANG_SST{0}_QP02_l{1:0>2}_DEPHY'.format(SST,lev) for lev in range(90,39,-1)]
  subcases[case] = subcases[case] + ['KUANG_SST{0}_QP01_l{1:0>2}_DEPHY'.format(SST,lev) for lev in range(90,39,-1)]
  subcases[case] = subcases[case] + ['KUANG_SST{0}_QM02_l{1:0>2}_DEPHY'.format(SST,lev) for lev in range(90,39,-1)]  
  subcases[case] = subcases[case] + ['KUANG_SST{0}_QM01_l{1:0>2}_DEPHY'.format(SST,lev) for lev in range(90,39,-1)]  
