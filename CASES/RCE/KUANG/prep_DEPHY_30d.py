...
#f = cdms2.open('/Users/romainroehrig/Desktop/TMP/KUANG/Out_klevel.nc')
f = cdms2.open('/Volumes/CNRM/TMP/MUSC/arp631.KUANG_CMIP6_RCEMIP_SST301.15/Out_klevel.nc')
...
g = cdms2.open('KUANG_SST{0}_DEPHY_30d.nc'.format(int(SST)),'w')
