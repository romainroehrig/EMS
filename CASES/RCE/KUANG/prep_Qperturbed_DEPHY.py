...
var3Dforc = ['pressure_forc','trad','temp_nudg','qv_nudg','qvadvh']
var2D = ['ts','ps']
...
titles['qvadvh'] = 'Specific humidity horizontal advection'
...
for lev0 in range(1,91):
    ...
    g = cdms2.open('KUANG_SST{0}_QP02_l{1:0>2}_DEPHY.nc'.format(int(SST),int(lev0)),'w')
    ...
    g.case = 'RCE/KUANG_SST{0}_QP02_l{1:0>2}'.format(SST,lev0)
...
for lev0 in range(1,91):
    ...
    g = cdms2.open('KUANG_SST{0}_QM02_l{1:0>2}_DEPHY.nc'.format(int(SST),int(lev0)),'w')
    ...
    g.case = 'RCE/KUANG_SST{0}_QM02_l{1:0>2}'.format(SST,lev0)
    g.startDate = '{year:4d}{month:02d}{day:02d}000000'.format(year=tmin.year,month=tmin.month,day=tmin.day)
    g.endDate = '{year:4d}{month:02d}{day:02d}000000'.format(year=tmax.year,month=tmax.month,day=tmax.day)
