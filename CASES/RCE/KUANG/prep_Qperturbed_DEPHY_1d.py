...
for lev0 in range(1,91):
    ...
    g = cdms2.open('KUANG_SST{0}_QP{2}_l{1:0>2}_DEPHY_1d.nc'.format(int(SST),int(lev0),ampl_name),'w')
...
for lev0 in range(1,91):
    ...
    g = cdms2.open('KUANG_SST{0}_QM{2}_l{1:0>2}_DEPHY_1d.nc'.format(int(SST),int(lev0),ampl_name),'w')
