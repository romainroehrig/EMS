...
#var2save = var2save + ['buoy','w_up_bud','dw_buoy','dw_fric','dw_Kd','dw_entr','dw_transp','dTv_up','ZUDALWAKE','ZBUOWAKE','ZALFW','ZWWMWX','ZVVER','ZDOMEGA','ZWW','ZWX','ZMW','ZMX','ZMTOT','eps_u','eps_u_org','eps_u_tur','aipcmt','knnd','knlab','del_u']

var2save = ['pf','zf','theta','qv','u','v','ql','rneb','cc','tke']
