...
# Binaries
bindir = '/home/gmgec/mrgc/roehrig/pack/arp642_climat.00.IMPIIFC1805.2yc.stab/bin'
...
# Namelists
ATMNAM = os.path.join(REP_MUSC, 'namelist/ARPCLIMAT/nam.atm.tl127l91r.CMIP6.v642.LPBLEoff')
