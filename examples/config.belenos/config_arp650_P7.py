...
# Binaries
bindir = '/home/gmgec/mrgc/roehrig/pack/arp650_climat.00.IMPIIFC1805.2yc.musc/bin'
...
# Namelists
ATMNAM = os.path.join(REP_MUSC, 'namelist/ARPCLIMAT/nam.atm.tl127l91r.P7.v650')
